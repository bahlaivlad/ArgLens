...
,
  ...
  virtualAlloc2FromApp_PageProtection: {
    0x1: "PAGE_NOACCESS",
    0x2: "PAGE_READONLY",
    0x4: "PAGE_READWRITE",
    0x8: "PAGE_WRITECOPY",
  ...
  virtualAllocFromApp_Protection: {
    0x1: "PAGE_NOACCESS",
    0x2: "PAGE_READONLY",
    0x4: "PAGE_READWRITE",
    0x8: "PAGE_WRITECOPY",
  ...
  virtualProtectFromApp_NewProtection: {
    0x1: "PAGE_NOACCESS",
    0x2: "PAGE_READONLY",
    0x4: "PAGE_READWRITE",
    0x8: "PAGE_WRITECOPY",
...
,
  createMutexEx_dwFlags: {
    0x1: "CREATE_MUTEX_INITIAL_OWNER"
  },
  createProcess_dwCreationFlags: {
    0x1: "DEBUG_PROCESS",
    ...
    0x800: "CREATE_SEPARATE_WOW_VDM",
    0x1000: "CREATE_SHARED_WOW_VDM",
    0x10000: "INHERIT_PARENT_AFFINITY",
    0x40000: "CREATE_PROTECTED_PROCESS",
    0x80000: "EXTENDED_STARTUPINFO_PRESENT",
    0x400000: "CREATE_SECURE_PROCESS",
    0x1000000: "CREATE_BREAKAWAY_FROM_JOB",
    0x2000000: "CREATE_PRESERVE_CODE_AUTHZ_LEVEL",
    0x4000000: "CREATE_DEFAULT_ERROR_MODE",
    0x8000000: "CREATE_NO_WINDOW"
  },
  createProcessAsUser_dwCreationFlags: {
    0x1: "DEBUG_PROCESS",
    0x2: "DEBUG_ONLY_THIS_PROCESS",
    0x4: "CREATE_SUSPENDED",
    0x8: "DETACHED_PROCESS",
  ...
  findFirstChangeNotification_dwNotifyFilter: {
  ...
  findFirstFileEx_dwAdditionalFlags: {
    0x1: "FIND_FIRST_EX_CASE_SENSITIVE",
    0x2: "FIND_FIRST_EX_LARGE_FETCH",
    0x4: "FIND_FIRST_EX_ON_DISK_ENTRIES_ONLY"
  },
  getFinalPathNameByHandle_dwFlags: {
  ...
  regGetValue_dwFlags: {
    0x1: "RRF_RT_REG_NONE",
    0x2: "RRF_RT_REG_SZ",
    0x4: "RRF_RT_REG_EXPAND_SZ",
    0x8: "RRF_RT_REG_BINARY",
    0x10: "RRF_RT_REG_DWORD",
    0x18: "RRF_RT_DWORD",
    0x20: "RRF_RT_REG_MULTI_SZ",
    0x40: "RRF_RT_REG_QWORD",
    0x48: "RRF_RT_QWORD",
    0xffff: "RRF_RT_ANY",
    0x10000: "RRF_SUBKEY_WOW6464KEY",
    0x20000: "RRF_SUBKEY_WOW6432KEY",
    0x10000000: "RRF_NOEXPAND",
    0x20000000: "RRF_ZEROONFAILURE"
  },
  regLoadMUIString_Flags: {
    0x1: "REG_MUI_STRING_TRUNCATE"
  },
  regSaveKeyEx_Flags: {
    0x1: "REG_STANDARD_FORMAT",
    0x2: "REG_LATEST_FORMAT",
    0x4: "REG_NO_COMPRESSION"
  }
};
